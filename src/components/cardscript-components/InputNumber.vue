<template>
  <div>
    ...
    <q-input label="Placeholder" v-model="clonedData.placeholder" />

    <q-input label="Minimum" v-model="clonedData.min" type="number" />
    <q-input label="Maximum" v-model="clonedData.max" type="number" />
